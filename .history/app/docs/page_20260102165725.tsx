          ...
          <div className="mt-12 p-8 bg-zinc-900/40 border border-zinc-800 rounded-xl flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
              ...
              <p className="text-sm text-zinc-400 leading-relaxed mb-6">
                Most LLMs struggle with visual spatial awareness and modern aesthetics. Gemini Flash models are uniquely fine-tuned on millions of high-end dribbble-style interactions and minimalist design patterns, making them the superior choice for frontend engineering.
              </p>
