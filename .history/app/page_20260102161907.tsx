      ...
      <nav className="fixed top-0 w-full z-50 border-b border-zinc-900/50 bg-zinc-950/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <span className="text-sm font-semibold tracking-tighter text-zinc-100">Gemini <span className="text-zinc-500 font-medium">Design MCP</span></span>
          </Link>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-5 p-4 border border-zinc-800 rounded bg-zinc-950">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-zinc-100 text-xs font-medium mb-1">Add to CLAUDE.md or AGENTS.md</p>
                <p className="text-zinc-500 text-[10px] leading-relaxed mb-3">
                  Add these instructions to your project&apos;s <code className="px-1 py-0.5 bg-zinc-900 text-zinc-400 rounded">CLAUDE.md</code> or <code className="px-1 py-0.5 bg-zinc-900 text-zinc-400 rounded">AGENTS.md</code> file to help your AI agent use the MCP effectively.
                </p>
                <div className="relative">
                  <div className="p-4 bg-zinc-900 border border-zinc-800 rounded overflow-x-auto text-[11px] text-zinc-300 space-y-3">
                    {/* Title */}
