...
**Gemini est ton développeur frontend.** Pour tout travail UI/design, utilise ce MCP. Les descriptions des outils contiennent toutes les instructions nécessaires.