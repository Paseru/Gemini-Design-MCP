          ...
          <div className="group p-5 border border-zinc-800 bg-zinc-900/30 hover:bg-zinc-900/60 transition-all duration-500 ease-out rounded-lg">
            ...
            <div className="mt-4 flex gap-1">
              {[1, 0.8, 0.6, 0.9, 1, 0.4, 0.7].map((h, i) => (
                <div key={i} className="flex-1 h-6 bg-zinc-800 flex items-end rounded-sm">
                    ...
                    history.logs.map((log, idx) => (
                      ...
                      >
                        <td className="px-4 py-3">
                          <code className="text-[10px] bg-zinc-800 px-1.5 py-0.5 text-zinc-300 border border-zinc-700 font-medium rounded">
                            {log.endpoint}
                          </code>
                        </td>
                        <td className="px-4 py-3 text-xs font-medium text-zinc-300">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            <div className={`w-1.5 h-1.5 rounded-full ${log.success ? 'bg-emerald-400' : 'bg-red-400'}`} />
                            <span className={`text-[9px] uppercase font-semibold ${log.success ? 'text-emerald-400' : 'text-red-400'}`}>
                              {log.success ? 'OK' : 'ERR'}
                            </span>
                          </div>
                        </td>
            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-px bg-zinc-800 border border-zinc-800 overflow-hidden rounded-lg">
                <div className="bg-zinc-900/50 p-4">
                  <span className="text-[9px] text-zinc-500 uppercase tracking-tighter block mb-0.5 font-semibold">Latency</span>
                  <div className="text-lg font-medium text-zinc-100">~1.2s</div>
                </div>
                <div className="bg-zinc-900/50 p-4">
                  <span className="text-[9px] text-zinc-500 uppercase tracking-tighter block mb-0.5 font-semibold">Uptime</span>
                  <div className="text-lg font-medium text-zinc-100">99.9%</div>
                </div>
                <div className="bg-zinc-900/50 p-4 col-span-2">
                  <div className="flex items-center justify-between">
                    <div>
                      <span className="text-[9px] text-zinc-500 uppercase tracking-tighter block mb-0.5 font-semibold">Infrastructure</span>
                      <div className="text-xs font-medium text-zinc-300">Global Edge Network</div>
                    </div>
